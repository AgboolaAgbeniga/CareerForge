          ...
          <div className="flex justify-between h-full items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-indigo-100 to-purple-100 border border-slate-200 overflow-hidden ring-2 ring-transparent hover:ring-indigo-100 cursor-pointer transition-all">
                <img src="https://i.pravatar.cc/150?u=career" alt="Profile" className="h-full w-full object-cover opacity-90" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold tracking-tight text-slate-900">Welcome, Alex. Let's launch your career.</h1>
              <p className="text-slate-500 mt-2 text-sm max-w-2xl">Complete these mission-critical steps to activate the AI matching engine.</p>
            </div>
            <div className="text-right hidden md:block">
              <span className="text-2xl font-bold text-slate-900">{progress}%</span>
              <span className="text-xs text-slate-400 font-medium block uppercase tracking-wide">Launch Readiness</span>
            </div>
          </div>
      ...
      <main className="flex-grow max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <section className="bg-white rounded-xl border border-indigo-200 p-6 relative overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-slate-900">Import Career Identity</h2>
                    <p className="text-sm text-slate-500">Sync your history to jumpstart the process.</p>
                  </div>
                </div>
                <span className="px-2.5 py-1 rounded-full bg-indigo-50 text-indigo-600 text-xs font-semibold border border-indigo-100">Step 1</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="font-semibold text-slate-800 text-sm">Import from LinkedIn</span>
                  <span className="text-xs text-slate-400 mt-1">Saves ~10 mins</span>
                ...
                >
                  ...
                  <span className="font-semibold text-slate-800 text-sm">Upload Resume</span>
            ...
            <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow opacity-90 hover:opacity-100">
              <div className="flex justify-between items-start mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Fill in the gaps to reach 100% strength.</p>
                  </div>
                </div>
                <span className="text-slate-400 text-xs font-semibold mt-1">Step 2</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="w-full bg-slate-100 rounded-full h-1.5 mb-6">
                  <div className="bg-amber-400 h-1.5 rounded-full transition-all duration-500" style={{ width: `${profileStrength}%` }}></div>
                </div>
              ...
              <div className="flex justify-between items-start mb-5">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Generate a tailored resume in seconds.</p>
                  </div>
                </div>
                <span className="text-slate-400 text-xs font-semibold mt-1">Step 3</span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                ...
                <div className="aspect-[3/4] rounded-lg bg-gradient-to-br from-slate-100 to-slate-200 border-2 border-indigo-500 relative cursor-pointer shadow-sm">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-wide">Modern</span>
                  </div>
                ...
                <div className="aspect-[3/4] rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 cursor-pointer flex items-center justify-center">
                  <span className="text-[10px] font-medium text-slate-400 uppercase tracking-wide">Minimal</span>
                </div>
                {/* Template 3 */}
                <div className="aspect-[3/4] rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 cursor-pointer flex items-center justify-center">
                  <span className="text-[10px] font-medium text-slate-400 uppercase tracking-wide">Creative</span>
                </div>
                {/* Template 4 */}
                <div className="aspect-[3/4] rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 cursor-pointer flex items-center justify-center">
                  <span className="text-[10px] font-medium text-slate-400 uppercase tracking-wide">Corp</span>
                </div>
              </div>

              <Button onClick={handleGenerateResume} className="w-full py-2.5 rounded-lg bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 transition-colors flex items-center justify-center gap-2">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Teach our AI what you're looking for.</p>
                  </div>
                </div>
                <span className="text-slate-400 text-xs font-semibold mt-1">Step 4</span>
              </div>

              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-medium text-slate-700 mb-1.5">Desired Role</label>
                    <input
                      type="text"
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-medium text-slate-700">Salary Range (Annual)</label>
                    <span className="text-xs font-bold text-indigo-600">${salaryMin}k - ${salaryMax}k</span>
                  </div>
                  <input
                    type="range"
                    min="30"
            ...
            <section className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <h2 className="text-sm font-semibold text-slate-900">Enable AI Career Coach</h2>
                    <p className="text-xs text-slate-500">Get daily insights and interview prep.</p>
                  </div>
                </div>
                <div className="relative inline-block w-10 align-middle select-none">
                  ...
                  <label
                    ...
                    style={{ backgroundColor: aiCoachEnabled ? '#6366F1' : '#CBD5E1' }}
                  ></label>
                </div>
              </div>
            </section>
            ...
            <div className="pt-4">
              <Button onClick={handleLaunch} className="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-semibold text-lg hover:shadow-lg hover:shadow-indigo-500/20 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3">
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-b from-indigo-50 to-white rounded-xl border border-indigo-100 p-5 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-sm font-semibold text-slate-800 mb-2">Pro Tip: Import Data</h3>
                  <p className="text-xs text-slate-600 leading-relaxed mb-4">
                    I've detected you have a LinkedIn profile. Importing it now will automatically fill 85% of your profile and increase match accuracy by 3x.
                  </p>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-slate-800 mb-1">Skill Gap Detected</h3>
                    <p className="text-xs text-slate-500 leading-relaxed mb-3">
                      Adding "React" and "Tailwind" to your skills section usually boosts visibility for Product Design roles.
                    </p>
                    <a href="#" className="text-xs font-medium text-slate-900 hover:text-indigo-600 hover:underline">Add Skills &rarr;</a>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-dashed border-slate-300 p-4 text-center">
                <p className="text-xs text-slate-500 mb-2">Stuck on onboarding?</p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                ...
                <span className="font-bold text-white tracking-tight text-lg">CAREER FORGE</span>
              </div>
              <p className="text-xs text-slate-500">Launch your career journey, powered by AI.</p>
            </div>
