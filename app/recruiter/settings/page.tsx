...
export default function RecruiterSettings() {
  ...
  const [userRole] = useState<'admin' | 'hiring-manager' | 'assistant'>('admin');
  ...
  const tabs = [
    { id: 'account' as const, label: 'Account', icon: User, description: 'Profile & authentication' },
    { id: 'company' as const, label: 'Company', icon: Building2, description: 'Profile & branding' },
    { id: 'team' as const, label: 'Team', icon: Users, description: 'Collaboration & workflow' },
    { id: 'communication' as const, label: 'Communication', icon: MessageSquare, description: 'Tools & messaging' },
    { id: 'notifications' as const, label: 'Notifications', icon: Bell, description: 'Alerts & preferences' },
    { id: 'privacy' as const, label: 'Privacy', icon: Shield, description: 'Data & compliance' },
    { id: 'system' as const, label: 'System', icon: SettingsIcon, description: 'Preferences & support' },
  ];
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800/60 bg-slate-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <a href="/recruiter" className="px-3 py-2 text-sm font-medium text-slate-400 hover:text-white transition-colors">Dashboard</a>
            <a href="/recruiter/jobs" className="px-3 py-2 text-sm font-medium text-slate-400 hover:text-white transition-colors">Jobs</a>
            <a href="/recruiter/candidates" className="px-3 py-2 text-sm font-medium text-slate-400 hover:text-white transition-colors">Candidates</a>
          </nav>
        ...
        <section className="lg:col-span-9">
          ...
          {activeTab === 'company' && (
            <div className="space-y-8">
              ...
              {/* Company Profile */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Company Profile</h3>
                <div className="space-y-6">
                  <div className="flex items-center gap-5">
                    <div className="w-20 h-20 rounded-xl bg-slate-900 border border-dashed border-slate-600 hover:border-purple-500 hover:bg-slate-800/50 flex flex-col items-center justify-center cursor-pointer transition-all group">
                      <Upload className="text-slate-500 group-hover:text-purple-400" size={20} />
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">Email Signature</label>
                    <textarea
                      value={companySettings.emailSignature}
                      onChange={(e) => setCompanySettings(prev => ({ ...prev, emailSignature: e.target.value }))}
                      disabled={userRole !== 'admin'}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-white">Show Company Profile to Candidates</p>
                      <p className="text-xs text-slate-500 mt-0.5">Let candidates see your company information</p>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
                        type="checkbox"
                        checked={companySettings.showProfile}
                        onChange={() => setCompanySettings(prev => ({ ...prev, showProfile: !prev.showProfile }))}
                        disabled={userRole !== 'admin'}
                ...
                <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between py-2 border-b border-slate-800">
                      <div>
                        <p className="text-sm text-white">Company description updated</p>
                        <p className="text-xs text-slate-500">by Sarah Connor • 2 hours ago</p>
                      </div>
                      <span className="text-xs text-slate-400">Admin</span>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-slate-800">
                      <div>
                        <p className="text-sm text-white">Email signature changed</p>
                        <p className="text-xs text-slate-500">by Sarah Connor • 1 day ago</p>
                      </div>
                      <span className="text-xs text-slate-400">Admin</span>
                    </div>
                  </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="space-y-3 mb-6">
                  <h4 className="text-sm font-medium text-slate-300">Current Team Members</h4>
                  <div className="flex items-center justify-between bg-slate-800/50 rounded-lg p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">sarah@cyberdyne.com</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between bg-slate-800/50 rounded-lg p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">john@cyberdyne.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-slate-300 mb-3">Invite New Team Member</h4>
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Workflow Preferences</h3>

                <div className="space-y-6">
                  <div>
                    <p className="text-sm text-slate-400 mb-3">Shortlist management:</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-white">Require Hiring Manager Approval</p>
                      <p className="text-xs text-slate-500 mt-0.5">Before interview scheduling</p>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
                        type="checkbox"
          ...
          {activeTab === 'communication' && (
            <div className="space-y-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-white">Communication Tools</h2>
              </div>

              {/* Messaging Preferences */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Messaging Preferences</h3>

                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-white">Shared Messaging Inbox</p>
                      <p className="text-xs text-slate-500 mt-0.5">All team members see candidate messages</p>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
                        type="checkbox"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-white">Allow Candidate Initiation</p>
                      <p className="text-xs text-slate-500 mt-0.5">Candidates can start conversations</p>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
                        type="checkbox"
              ...
              {/* Calendar Sync */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Calendar Integration</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Sync interviews with your calendar</p>
                      </div>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { name: 'Interview Invitation', icon: '📅', description: 'Schedule and confirm interviews' },
                    { name: 'Follow-Up Reminder', icon: '⏰', description: 'Keep candidates engaged' },
                    { name: 'Offer Letter', icon: '📄', description: 'Formal job offers' },
                    { name: 'Rejection/Feedback', icon: '💬', description: 'Professional rejections' },
                  ].map((template) => (
                    <div key={template.name} className="bg-slate-800/50 border border-slate-700 rounded-lg p-4 hover:border-slate-600 transition-colors">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                ...
                <div className="space-y-4">
                  {[
                    { key: 'candidateMessages', label: 'Candidate Messages', desc: 'New messages from candidates' },
                    { key: 'interviewConfirmations', label: 'Interview Confirmations', desc: 'Interview scheduling updates' },
                    { key: 'jobUpdates', label: 'Job Posting Updates', desc: 'Changes to your job listings' },
                  ].map((item) => (
              ...
              {/* Delivery Channels */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Delivery Channels</h3>
                  ...
                  {[
                    ...
                    <div key={item.key} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-white">{item.label}</p>
                          <p className="text-xs text-slate-500 mt-0.5">Receive notifications via {item.label.toLowerCase()}</p>
                        </div>
                      </div>
                      <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                        <input
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                ...
                <p className="text-sm text-slate-400 mb-6">
                  Download your data including candidate lists, resumes, and reports.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button className="flex items-center gap-3 p-4 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-slate-600 transition-colors">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white">Candidate Data</p>
              ...
              {/* Compliance */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Compliance</h3>

                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-4 bg-slate-800/30 rounded-lg">
                    <AlertTriangle className="text-amber-500 mt-0.5" size={16} />
                    <div>
                      <p className="text-sm font-medium text-white">GDPR Compliance</p>
                      <p className="text-xs text-slate-400 mt-1">
                        We comply with GDPR requirements for data protection and privacy rights in the European Union.
                      </p>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-slate-800/30 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white">CCPA Compliance</p>
                      <p className="text-xs text-slate-400 mt-1">
          ...
          {activeTab === 'system' && (
            <div className="space-y-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-white">System & Support</h2>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-0.5">Increase contrast for better visibility</p>
                      </div>
                    </div>
                    <div className="relative inline-block w-10 h-6 align-middle select-none transition duration-200 ease-in">
                      <input
              ...
              {/* Help Center */}
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-medium text-white mb-4">Help Center</h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button className="flex items-center gap-3 p-4 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-slate-600 transition-colors">
                    <HelpCircle className="text-slate-400" size={20} />
                    <div>
                      <p className="text-sm font-medium text-white">Recruiter Documentation</p>
                  ...
                  <button className="flex items-center gap-3 p-4 bg-slate-800/50 border border-slate-700 rounded-lg hover:border-slate-600 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Chat or email support</p>
                    </div>
                  </button>
                </div>
              </div>
