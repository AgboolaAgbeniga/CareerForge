...
async def get_job_matches(data: dict):
    ...
    try:
        ...
        matches = await matcher.find_best_matches(job_seeker, jobs, 10)
...
async def get_candidate_matches(data: dict):
    ...
    try:
        ...
        analyses = await matcher.analyze_candidates_for_job(job, candidates)
...
async def get_hiring_suggestions(data: dict):
    ...
    try:
        ...
        suggestions = await matcher.get_hiring_suggestions(data)
        return suggestions
