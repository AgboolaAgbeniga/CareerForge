...
export const KPICard: React.FC<KPICardProps> = ({
    ...
    return (
        <motion.div
            ...
            className={`bg-canvas border-hairline shadow-none p-5 rounded-sm group hover:border-primary transition-colors relative overflow-hidden`}
        >
            ...
            <div className="space-y-1">
                <p className="text-[10px] font-mono text-body uppercase tracking-[0.08px]">{title}</p>
